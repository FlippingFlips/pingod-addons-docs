var relearn_search_index=[{content:`Start with duplicating the ScoreMode.tscn file from the addons.
...
`,description:"",tags:null,title:"Creating custom score mode scene",uri:"/pingod-addons-docs/tips-guides/custom-score-mode/index.html"},{content:`Image edit Tools Here are some tools we use a lot and have been used when making games for pinball.
...
🔗 Gimp (chocolatey)
`,description:"",tags:null,title:"Image Tools",uri:"/pingod-addons-docs/game-assets/tools/image-tools/index.html"},{content:"",description:"",tags:null,title:"Tools",uri:"/pingod-addons-docs/game-assets/tools/index.html"},{content:`This scene is the first to be loaded as a base display set in the projects settings and the scene is never removed from the game, but can add / remove modes like removing the Attract then adding a Game scene.
...
Godot Overrides _EnterTree Gets the Machine plugin and hooks up to the SwitchCommand handler to listen for service menu enter switch _Ready Gets Resources plugin Gets PinGodGame plugin Hooks to signals listed below _Input - Actions reset = resets the game F3 PinGodGame - Signals connected PinGodGame.GameStarted	= Calls StartGame which loads the Game scene PinGodGame.GameEnded	= Removes the Game from Modes tree. PinGodGame.ServiceMenuExit	= Reloads the scene. ReloadCurrentScene `,description:"",tags:null,title:"Main Scene",uri:"/pingod-addons-docs/base-scenes/mainscene/index.html"},{content:`Attract Class Reference Class Reference
`,description:"",tags:null,title:"Attract Scene",uri:"/pingod-addons-docs/base-scenes/attractscene/index.html"},{content:`This scene is loaded from the attract mode. (Add to favorites for quick access)
...
`,description:"",tags:null,title:"Creating custom playfield switch window",uri:"/pingod-addons-docs/tips-guides/playfield-switch-window/index.html"},{content:` Filter Godot files by ScoreEntry Duplicate the ScoreEntry.tscn and move to your res://autoload directory Add the packed scene location, replacing any existing in the res:autoload/Resources.tscn Add the new scene into the Game.tscn so it knows where your version is Edit away without effecting the addons and script. You can take it further than cosmetic from here with a script. Things you can try in the scene:
Setting a theme on the top control ScoreEntry, which will set all in the scene, provided you have made custom theme entries like Label themes. Changing the labels font and colors, sizes, outlines, shadows. If you change the size you can Select Char Margin to adjust the distance between the characters. `,description:"",tags:null,title:"Creating custom Score Entry scene",uri:"/pingod-addons-docs/tips-guides/scoreentry/index.html"},{content:`We’ll use the template project we built for PinGod P-ROC for this guide / overview. examples/pingod-netproc-pdb
...
`,description:"",tags:null,title:"Getting Started",uri:"/pingod-addons-docs/pingodnetproc/getting-started/index.html"},{content:`This scene is autoloaded with the game with all of its child scenes.
...
`,description:"",tags:null,title:"ScoreMode - Scene",uri:"/pingod-addons-docs/base-scenes/score-mode/index.html"},{content:` Building Project You should be able to build the project with dotnet build providing you have linked or added the addons directory.
...
`,description:"",tags:null,title:"Autoloads",uri:"/pingod-addons-docs/pingodnetproc/autoloads/index.html"},{content:`This BaseMode scene is loaded in the Game.tscn Modes scene used in the BasicGame project. A basic mode which has a saucer (kicker) and starts multiball when active.
...
`,description:"",tags:null,title:"ProcScene - Main Scene",uri:"/pingod-addons-docs/pingodnetproc/procscene/index.html"},{content:`The following guides aim to have you up and running the BasicGameGodot window from the pingod-basicgame.
Install, setup Godot
Configure Godot
Basic Game Setup
...
`,description:"",tags:null,title:"Mode - PinGodProcMode:IMode",uri:"/pingod-addons-docs/pingodnetproc/pingodprocmode/index.html"},{content:` Empty Project Steps below to create new empty project
...
SET cDir=%cd% cd ../pingod-addons/addons SET addDir=%cd% cd %cDir% mklink /D addons "%addDir%" Open project in Godot Open the project in Godot (godot -e) and you’ll see the directory which you have linked Playing the game will ask you to define a scene to load Add Scene Add new Node2D Rename the node and save it as MyScene Save in the root directory and not the addons directory The new scene should be at res://MyScene.tscn Here is the project after adding MyScene.tscn with the addons linked
Run project Hit play in Godot and run project. Select this scene as the current scene to load.
`,description:"",tags:null,title:"PinGodGame Projects - Create Template",uri:"/pingod-addons-docs/tips-guides/new-project-pingodgame-template/index.html"},{content:`Most PinGod Godot plugins are included in the addons/AutoLoad directory.
...
`,description:"",tags:null,title:"Plugins - Autoload",uri:"/pingod-addons-docs/plugins/index.html"},{content:`Basic Score mode with charachter selection for players at end of game
...
`,description:"",tags:null,title:"Score Entry",uri:"/pingod-addons-docs/base-scenes/score-entry-mode/index.html"},{content:`Base Tilt scene to act on any machine tilting actions and displaying
...
`,description:"",tags:null,title:"Blank Empty Projects",uri:"/pingod-addons-docs/tips-guides/new-project/index.html"},{content:`The nuget package NetProc.Data will provide you with .sql files to seed database data.
...
`,description:"",tags:null,title:"PinGodGame Projects - New From Template",uri:"/pingod-addons-docs/tips-guides/create-pingodgame-template/index.html"},{content:`A rundown and overview how we have made the templates and assets for the simulator.
...
`,description:"",tags:null,title:"Simulator - Assets",uri:"/pingod-addons-docs/game-assets/simulator-assets/index.html"},{content:`Godot Actions - Window inputs Godot uses Actions and we can use the input map to map switches / actions to them. In the projects Input Map add switches to keys like the example below.
...
`,description:"",tags:null,title:"PinGodGame Projects - Add a C# Script",uri:"/pingod-addons-docs/tips-guides/create-pingodgame-template-script/index.html"},{content:`🗒 MachineConfig Class Reference
Ball Search Machine Items Recording Playback Switch Window Trough PlungerLane BallSaver `,description:"",tags:null,title:"Plugin - Machine",uri:"/pingod-addons-docs/plugins/machine/index.html"},{content:` Scenes using this Most modes rely on this being loaded by using GetNode<PinGodGame>("/root/PinGodGame") from the script.
...
PinGodGame.tscn Scene Guide PinGodGame.cs Class Definitions `,description:"",tags:null,title:"Plugin - PinGodGame",uri:"/pingod-addons-docs/plugins/pingodgame/index.html"},{content:`The Resources plugin is a preloader of assets and scenes which are called Packed Scenes.
...
`,description:"",tags:null,title:"Plugin - Resources",uri:"/pingod-addons-docs/plugins/resources/index.html"},{content:`This scene overrides from the default PinGodGame.tscn from autoload/PinGodGame.tscn.
...
`,description:"",tags:null,title:"PinGodGamePROC",uri:"/pingod-addons-docs/pingodnetproc/pingodgame.tscn/index.html"},{content:`Helper class for audio.
...
`,description:"",tags:null,title:"Plugin - AudioManager",uri:"/pingod-addons-docs/plugins/audiomanager/index.html"},{content:`This class writes coil, lamp and led states to memory. It also read switch states from memory.
...
Option Description Is Enabled Enable/Disable, this allows to have plug-in enabled but disable it here Write Delay Delay for the loop to write to memory, 10 is a good default, less cpu, responsive Read Delay Delay for the loop to read from memory, 10 is a good default, less cpu, responsive MapName should be left, the controller uses this name Coil Total If you need to increase coil count, it needs to match the VP script Led Total If you need to increase led count, it needs to match the VP script Lamp Total If you need to increase lamp count, it needs to match the VP script Switch Total If you need to increase switch count, it needs to match the VP script MutexName should be left, the controller uses this name `,description:"",tags:null,title:"Plugin - MemoryMap",uri:"/pingod-addons-docs/plugins/memorymap/index.html"},{content:`You can ignore this if you have installed with chocolatey as this will be added for you on install. You should be able to run godot in any terminal.
...
Windows UI - (Option 1) Push windows key and type path, this will filter to Edit the System Variables Push enter to open the System Properties window, from here select Environment Variables In the Environment Variables - System Variables (bottom window pane) find variable named Path and open this Add in the godot path in this section, OK out of the windows `,description:"",tags:null,title:"Godot - Configuration",uri:"/pingod-addons-docs/getting-started/configuration/index.html"},{content:`This is the main GameController for P-ROC which is based from a Database Game Controller in NetProc.
...
GetTopScores() // get top scores in database. GetAdjustment("DISP_MODE") // gets an adjustment value GetAudit("CREDITS") // gets an audit value SetAdjustment("DISP_MODE", 2) // gets an adjustment value SetAudit("CREDITS", 50) // gets an audit value`,description:"",tags:null,title:"PinGodProc GameController",uri:"/pingod-addons-docs/pingodnetproc/pingod-procgame-controller/index.html"},{content:`The Trough.tscn handles the ball trough, ball saving, trough switches, early save switches, shooter lane switch.
...
`,description:"",tags:null,title:"Mode - Base Modes",uri:"/pingod-addons-docs/pingodnetproc/proc-basemodes/index.html"},{content:`Using Git to clone the repositories
...
`,description:"",tags:null,title:"BasicGame - Git Clone",uri:"/pingod-addons-docs/getting-started/basicgame-setup-git/index.html"},{content:`To run the pingod-basigame project in the examples folder you will need the addons directory linked or copied.
...
`,description:"",tags:null,title:"BasicGame - Linking addons",uri:"/pingod-addons-docs/getting-started/basicgame-setup-addons/index.html"},{content:`Use Alt+D in the project directory, type godot -e then enter to load project
...
Add on linking file what it does _link_addons.bat Links the pingod-addons the epositories addons directory into the BasicGameGodot project `,description:"",tags:null,title:"BasicGame - Project.Godot",uri:"/pingod-addons-docs/getting-started/basicgame-project/index.html"},{content:` Build The MainScene should be visible and you can build the project (top right button).
...
`,description:"",tags:null,title:"BasicGame - Godot Project Loaded Run Game",uri:"/pingod-addons-docs/getting-started/basicgame-godot/index.html"},{content:`Window controls key action F1 Settings Menu F2 Toggle Window Border F8 Quit? Settings Saved to users app_data directory. See Game Save Data
Audio Display Fullscreen FPS Game Some basic game settings PinGod Read/Write states can be disabled when not running with a simulator. `,description:"",tags:null,title:"BasicGame - Window Settings",uri:"/pingod-addons-docs/getting-started/basicgame-window/index.html"},{content:`In the appdata directory under the game name. %AppData%\\Godot\\app_userdata\\BasicGameGodot\\Logs.
...
`,description:"",tags:null,title:"Mode - AttractMode",uri:"/pingod-addons-docs/pingodnetproc/attractmode/index.html"},{content:`In the appdata directory under the game name. %AppData%\\Godot\\app_userdata\\BasicGameGodot\\settings.save
...
`,description:"",tags:null,title:"User Game setting / data",uri:"/pingod-addons-docs/getting-started/game-save-data/index.html"},{content:`In the modes directory you’ll find ScoreDisplayProcMode.cs. This is a P-ROC mode script using the base PinGodProcMode because we need visible layers here.
...
`,description:"",tags:null,title:"Mode - ScoreDisplayProcMode",uri:"/pingod-addons-docs/pingodnetproc/scoredisplayprocmode/index.html"},{content:`An overview of the parts used to create the BasicGame with PinGod.
...
Score Entry Scene
Tilt Scene
`,description:"",tags:null,title:"BasicGame - Scenes Overview",uri:"/pingod-addons-docs/base-scenes/index.html"},{content:`Game Window Switches Switches need to be added to _gameWindowSwitches in PinGodGame.tscn.
...
`,description:"",tags:null,title:"BasicGame - Game",uri:"/pingod-addons-docs/getting-started/basicgame-game/index.html"},{content:`Now that the game is building and running it can be launched with Visual Pinball.
...
`,description:"",tags:null,title:"BasicGame - Visual Pinball",uri:"/pingod-addons-docs/getting-started/basicgame-game-vp/index.html"},{content:`In the modes directory you’ll find MyMode.cs. This will be loaded when the default game is run.
...
`,description:"",tags:null,title:"Simulator - Switch Window",uri:"/pingod-addons-docs/pingodnetproc/simulator-window/index.html"},{content:`Tools are custom add on objects in Godot. You can use the attribute [Tool] and turn a script into a tool.
They will be available to search and select from in Godot so you can add to your scenes.
`,description:"",tags:null,title:"Tools / Controls",uri:"/pingod-addons-docs/tools/index.html"},{content:`There is a demo table provided in the visual_pinball directory.
...
`,description:"",tags:null,title:"Simulator - Visual Pinball",uri:"/pingod-addons-docs/pingodnetproc/simulator-vp/index.html"},{content:`Anything we find useful to you will go here. Any tips, tutorials.
`,description:"",tags:null,title:"Tip / Guides / Notes",uri:"/pingod-addons-docs/tips-guides/index.html"},{content:`Notes and reminders on some assets and modes.
...
`,description:"",tags:null,title:"Assets - Video",uri:"/pingod-addons-docs/game-assets/video/index.html"},{content:`Basic way to use a Timer as a Saucer or Kicker, the scene using this control should connect to the switch signals sent from them. See BasicGame
...
`,description:"",tags:null,title:"BallStackPinball (Timer)",uri:"/pingod-addons-docs/tools/ballstackpinball/index.html"},{content:`You can export the game to be used without the Godot editor. The Build folder will be used to export to.
...
`,description:"",tags:null,title:"BasicGame - Exporting",uri:"/pingod-addons-docs/getting-started/basicgame-game-exporting/index.html"},{content:`A label that blinks on a timer with optional methods for controlling the blink
`,description:"",tags:null,title:"BlinkingLabel (Label)",uri:"/pingod-addons-docs/tools/blinkinglabel/index.html"},{content:`Also See BasicGame - Simulator Export
...
`,description:"",tags:null,title:"Exporting",uri:"/pingod-addons-docs/exporting/exports/index.html"},{content:`Add translations for the game. There are also defaults to cover most standard pinball messages in addons\\assets\\Localization
...
Project.godot default translation [locale] translations=PoolStringArray( "res://addons/assets/Localization/pingod_default_lang.en.translation" ) locale_filter=[ 0, [ ] ]`,description:"",tags:null,title:"Language files",uri:"/pingod-addons-docs/languages/lang-files/index.html"},{content:`Set the exports in the scene from Godot or tscn. and other options.
`,description:"",tags:null,title:"PinballLanesNode (PinGodGameMode:Node)",uri:"/pingod-addons-docs/tools/pinballlanesnode/index.html"},{content:`Handles a bank of targets, the light states and watches for completion
`,description:"",tags:null,title:"PinballTargetsBank (Node)",uri:"/pingod-addons-docs/tools/pinballtargetsbank/index.html"},{content:`Auto Switch handlers (No scripting) In the BasicGame, Visual Pinball table switches are added to a simulator collection named AllSwitches.
...
`,description:"",tags:null,title:"BasicGame - Create first asset scene",uri:"/pingod-addons-docs/getting-started/basicgame-create-asset-scene/index.html"},{content:`This script is autoloaded from the scene when the display window is launched and has many methods.
...
`,description:"",tags:null,title:"Export Windows Icons",uri:"/pingod-addons-docs/exporting/export-windows-icon/index.html"},{content:"Overview Links Basic Game Assets & Packs BasicGame Basic Game Resources BasicGame Audio Manager AudioManager Videos and format Videos ",description:"",tags:null,title:"Game Assets",uri:"/pingod-addons-docs/game-assets/index.html"},{content:`This doesn’t apply if you decide to have a single executable and pck, so you can skip this
...
`,description:"",tags:null,title:"BasicGame - Script Editing Setup",uri:"/pingod-addons-docs/getting-started/basicgame-script-editing/index.html"},{content:`Quick guide on how to record and playback a game.
...
`,description:"",tags:null,title:"P-ROC - PinGod NetProc",uri:"/pingod-addons-docs/pingodnetproc/index.html"},{content:`Pinball game framework
`,description:"",tags:null,title:"About PinGod",uri:"/pingod-addons-docs/about/index.html"},{content:` What is it? PinGod is for creating pinball game logic with graphics display window.
...
`,description:"Documentation for PinGod games",tags:null,title:"Home",uri:"/pingod-addons-docs/index.html"},{content:"",description:"",tags:null,title:"Categories",uri:"/pingod-addons-docs/categories/index.html"},{content:"",description:"",tags:null,title:"Tags",uri:"/pingod-addons-docs/tags/index.html"}]